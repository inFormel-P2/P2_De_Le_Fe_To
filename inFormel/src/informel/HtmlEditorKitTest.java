  ...
  public HtmlEditorKitTest()
  {
    SwingUtilities.invokeLater(new Runnable()
    {
      public void run()
      {
        ...
        try {
            jEditorPane.setPage(new File("/Users/denisehfg/Documents/Semester 2/Programmieren 2/inFormel/P2_De_Le_Fe_To/HTML_Theorie/HTML_Programmieren/HTML_Template.html").toURI().toURL());
        } catch (IOException e) {
            //System.err.println("Attempted to read a bad URL: " + helpURL);
            System.out.println("ich hab kein bock mehr wehe du wirfst einen fehler!");
        }
